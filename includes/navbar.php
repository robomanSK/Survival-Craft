<nav class="site-nav">
  <div class="container">
    ...
    <div class="nav-right">
      <ul class="nav-list">
        <li><a class="nav-link" href="index.php" data-text-sk="Domov" data-text-cz="Domů">Domov</a></li>
        <li><a class="nav-link" href="vip.php" data-text-sk="VIP" data-text-cz="VIP">VIP</a></li>
